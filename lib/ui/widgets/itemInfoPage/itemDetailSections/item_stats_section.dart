...
class ItemStatsSection extends StatelessWidget {
  ...
  ItemStatsSection({Key? key, required this.itemDto}) : super(key: key);


  @override
  Widget build(BuildContext context) {
    final List<String>? baseStats = ["물리 기본 성능", "마법 기본 성능", "물리 방어력", "마법 방어력", "공격 주기"];
    final List baseParamList = [itemDto.damagePhys, itemDto.damageMag, itemDto.defensePhys, itemDto.defenseMag, itemDto.delayMs];
